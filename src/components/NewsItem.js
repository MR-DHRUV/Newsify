...
const NewsItem = (props)=> {
    ...
    return (
        <div className='my-5 mx-3 item-div' id='resp' >
            <div className="card my-card">
                <img src={props.imageUrl} className="card-img-top my-img" alt="Hang On ! Its Loading" height="203vh" />
                <div className="card-body">
                    <h5 className="card-title heading">{props.title} ..<br/></h5>
                    <p className="card-text tag"><small>Source: {props.source}</small></p>
